    ...
    <div align="center">
        <div className="w-9/12 space-y-6">
            ...
            <div className="block space-y-4 sm:space-y-0 sm:flex sm:justify-between sm:items-center">
                ...
                <h1 className="font-sans text-gray-900 dark:text-white text-base flex gap-2 items-center">Made with <SiReact color="AQUA"/> React by <a href={`https://github.com/${UserData.github}`}>kadybot</a></h1>
            </div>
        </div>
        <br/>
    </div>)
